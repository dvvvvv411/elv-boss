...
const menuItems = [
  ...
  { title: "Einnahmen", icon: Wallet, active: false },
  { title: "Mitglieder", icon: Users, active: false },
  { title: "Auszahlungen", icon: ArrowDownToLine, active: false },
  { title: "Analytics", icon: BarChart3, active: false },
  { title: "Einstellungen", icon: Settings, active: false },
];
